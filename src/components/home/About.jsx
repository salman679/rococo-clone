      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="space-y-6 text-lg text-gray-300 leading-relaxed">
          <p>
            ...
            that empowers healthcare providers across the Midwest and beyond to
            conquer their most pressing operational challenges. We deliver this
            through a powerful and flexible AI platform that powers both a{" "}
            <span className="text-white font-semibold">
              suite of ready-to-deploy solutions
            </span>{" "}
            for documentation and compliance, and the creation of{" "}
            <span className="text-white font-semibold">
              fully bespoke engines
            </span>{" "}
          ...
          <p>
            ...
            <span className="text-white font-semibold">
              meticulously gathered real-world data
            </span>{" "}
            from professionals to build the exceptionally robust and uniquely
          ...
          <p>
            ...
            <span className="text-white font-semibold">
              immediate solution from our product suite
            </span>{" "}
            or a{" "}
            <span className="text-white font-semibold">
              strategic partner to build a custom engine
            </span>{" "}
